...
class Timestamp<T> implements Comparable<Timestamp<?>> {
    ...
    public Timestamp(LocalDateTime dateTime, T element) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(dateTime, timestamp.dateTime);
    }
    ...
    public String toString() {
        return dateTime.toString() + " " + element.toString();
    }
}

class Scheduler<T> {
    final List<Timestamp<T>> timestamps;
    ...
    public Timestamp<T> last() {
        ...
        return timestamps.stream()
                .filter(t -> t.dateTime.isBefore(dateNow))
    ...
    public Timestamp<T> next() {
        LocalDateTime dateNow = LocalDateTime.now();
        return timestamps.stream()
                .filter(t -> t.dateTime.isAfter(dateNow))
