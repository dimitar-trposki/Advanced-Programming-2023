package Septemvri.Kolokviumski.K14;
...
class CarCollection {
    ...
    public void sortByPrice(boolean ascending) {
        cars = cars.stream()
                .sorted(ascending ? Comparator.comparing(Car::getPrice).thenComparing(Car::getPower) :
                        Comparator.comparing(Car::getPrice).thenComparing(Car::getPower).reversed())
